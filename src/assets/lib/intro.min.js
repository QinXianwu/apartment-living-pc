...
!(function (t, e) {
  ...
  var a,
    ...
    q = function (t, e) {
      return arguments.length < 2 ? R(c[t]) : c[t] && c[t][e];
    },
    B = S({}.isPrototypeOf),
    M = q("navigator", "userAgent") || "",
    H = c.process,
    F = c.Deno,
    $ = (H && H.versions) || (F && F.version),
    D = $ && $.v8;
  D && (l = (a = D.split("."))[0] > 0 && a[0] < 4 ? 1 : +(a[0] + a[1])),
    !l &&
      M &&
      (!(a = M.match(/Edge\/(\d+)/)) || a[1] >= 74) &&
      (a = M.match(/Chrome\/(\d+)/)) &&
      (l = +a[1]);
  var z = l,
    G =
    ...
    W = G && !Symbol.sham && "symbol" == typeof Symbol.iterator,
    V = c.Object,
    U = W
      ? function (t) {
    ...
    J = function (t) {
      if (P(t)) return t;
      throw X(Y(t) + " is not a function");
    },
    Q = function (t, e) {
      var n = t[e];
      return null == n ? void 0 : J(n);
    },
    Z = c.TypeError,
    tt = Object.defineProperty,
    et = function (t, e) {
      try {
        tt(c, t, { value: e, configurable: !0, writable: !0 });
      } catch (n) {
        c[t] = e;
      }
      return e;
    ...
    dt = c.Symbol,
    gt = dt && dt.for,
    vt = W ? dt : (dt && dt.withoutSetter) || ft,
    bt = function (t) {
      if (!st(pt, t) || (!G && "string" != typeof pt[t])) {
        var e = "Symbol." + t;
        G && st(dt, t) ? (pt[t] = dt[t]) : (pt[t] = W && gt ? gt(e) : vt(e));
      }
      return pt[t];
    },
    mt = c.TypeError,
    ...
    wt = function (t, e) {
      ...
      var n,
        i = Q(t, yt);
      if (i) {
        if ((void 0 === e && (e = "default"), (n = d(i, t, e)), !L(n) || U(n)))
          return n;
      ...
      return (
        ...
        (function (t, e) {
          var n, i;
          if ("string" === e && P((n = t.toString)) && !L((i = d(n, t))))
            return i;
          if (P((n = t.valueOf)) && !L((i = d(n, t)))) return i;
          if ("string" !== e && P((n = t.toString)) && !L((i = d(n, t))))
            return i;
    ...
    xt = c.document,
    St = L(xt) && L(xt.createElement),
    jt = function (t) {
      return St ? xt.createElement(t) : {};
    },
    Ct =
      !h &&
      !u(function () {
    ...
    Et = {
      f: h
        ...
        : function (t, e) {
            ...
            if (st(t, e)) return m(!d(b.f, t, e), t[e]);
          },
    },
    At =
      h &&
    ...
    Nt = function (t) {
      if (L(t)) return t;
      throw Tt(It(t) + " is not an object");
    },
    Ot = c.TypeError,
          ...
          ? function (t, e, n) {
              if (
                ...
                i &&
                  ...
                  ((t[e] = n.value),
                  (n = {
                    configurable: qt in n ? n.configurable : i.configurable,
                    enumerable: Rt in n ? n.enumerable : i.enumerable,
                    writable: !1,
                  }));
              }
              return Pt(t, e, n);
    ...
    Ht = h
      ? function (t, e, n) {
          return Mt.f(t, e, m(1, n));
        }
      : function (t, e, n) {
          return (t[e] = n), t;
        },
    Ft = S(Function.toString);
  P(it.inspectSource) ||
  ...
  var $t,
    ...
    Gt = it.inspectSource,
    Wt = c.WeakMap,
    Vt = P(Wt) && /native code/.test(Gt(Wt)),
    Ut = ot("keys"),
    Kt = function (t) {
    ...
    Qt = c.WeakMap;
  if (Vt || it.state) {
    var Zt = it.state || (it.state = new Qt()),
      te = S(Zt.get),
      ee = S(Zt.has),
      ne = S(Zt.set);
    ($t = function (t, e) {
      if (ee(Zt, t)) throw new Jt(Xt);
      return (e.facade = t), ne(Zt, t, e), e;
    }),
      (Dt = function (t) {
        return te(Zt, t) || {};
      }),
    ...
    (Yt[ie] = !0),
      ($t = function (t, e) {
        if (st(t, ie)) throw new Jt(Xt);
        return (e.facade = t), Ht(t, ie, e), e;
      }),
      (Dt = function (t) {
        return st(t, ie) ? t[ie] : {};
      }),
  ...
  var oe = {
      ...
      has: zt,
      enforce: function (t) {
        return zt(t) ? Dt(t) : $t(t, {});
      },
      getterFor: function (t) {
        return function (e) {
          var n;
          if (!L(e) || (n = Dt(e)).type !== t)
            throw Jt("Incompatible receiver, " + t + " required");
          return n;
        };
      },
    },
    re = Function.prototype,
    ae = h && Object.getOwnPropertyDescriptor,
    le = st(re, "name"),
    se = {
      EXISTS: le,
      PROPER: le && "something" === function () {}.name,
      CONFIGURABLE: le && (!h || (h && ae(re, "name").configurable)),
    },
    ce = r(function (t) {
      ...
      (t.exports = function (t, n, r, a) {
        ...
        P(r) &&
          ...
          (!st(r, "name") || (e && r.name !== f)) && Ht(r, "name", f),
          (l = i(r)).source ||
    ...
    fe = function (t) {
      var e = +t;
      return e != e || 0 === e ? 0 : (e > 0 ? he : ue)(e);
    },
    pe = Math.max,
    de = Math.min,
    ge = function (t, e) {
      var n = fe(t);
      return n < 0 ? pe(n + e, 0) : de(n, e);
    },
    ve = Math.min,
    be = function (t) {
      return t > 0 ? ve(fe(t), 9007199254740991) : 0;
    },
    me = function (t) {
      return be(t.length);
    },
    ...
    Se = function (t, e) {
      var n,
        ...
        o = 0,
        r = [];
      for (n in i) !st(Yt, n) && st(i, n) && xe(r, n);
      for (; e.length > o; ) st(i, (n = e[o++])) && (~_e(r, n) || xe(r, n));
      return r;
    },
    je = [
      "constructor",
    ...
    Te = function (t, e, n) {
      for (var i = Ie(e), o = Mt.f, r = Et.f, a = 0; a < i.length; a++) {
        var l = i[a];
        st(t, l) || (n && st(n, l)) || o(t, l, r(e, l));
      }
    },
    Ne = /#|\.prototype\./,
    Oe = function (t, e) {
      var n = Le[Pe(t)];
      return n == qe || (n != Re && (P(e) ? u(e) : !!e));
    },
    Pe = (Oe.normalize = function (t) {
    ...
    He = function (t, e) {
      var n,
        ...
        s = t.global,
        u = t.stat;
      if ((n = s ? c : u ? c[l] || et(l, {}) : (c[l] || {}).prototype))
        for (i in e) {
          if (
            ((r = e[i]),
            (o = t.noTargetGet ? (a = Me(n, i)) && a.value : n[i]),
            !Be(s ? i : l + (u ? "." : "#") + i, t.forced) && void 0 !== o)
          ) {
            if (typeof r == typeof o) continue;
            Te(r, o);
          }
          (t.sham || (o && o.sham)) && Ht(r, "sham", !0), ce(n, i, r, t);
        }
    },
    Fe = {};
  Fe[bt("toStringTag")] = "z";
  var $e,
    De = "[object z]" === String(Fe),
    ze = bt("toStringTag"),
    Ge = c.Object,
    We =
      "Arguments" ==
    ...
    en =
      h && !At
        ...
        : function (t, e) {
            Nt(t);
            for (var n, i = O(e), o = tn(e), r = o.length, a = 0; r > a; )
              Mt.f(t, (n = o[a++]), i[n]);
            return t;
          },
    nn = { f: en },
    on = q("document", "documentElement"),
    rn = Kt("IE_PROTO"),
    an = function () {},
    ln = function (t) {
    ...
    cn = function () {
      ...
      cn =
        "undefined" != typeof document
          ? document.domain && $e
            ? sn($e)
            : (((e = jt("iframe")).style.display = "none"),
              on.appendChild(e),
              (e.src = String("javascript:")),
              (t = e.contentWindow.document).open(),
              t.write(ln("document.F=Object")),
              t.close(),
              t.F)
          : sn($e);
      for (var n = je.length; n--; ) delete cn.prototype[je[n]];
      return cn();
    };
  Yt[rn] = !0;
  var un,
    ...
    bn = oe.get,
    mn = ot("native-string-replace", String.prototype.replace),
      ...
      if (
        (p &&
          ...
          s.lastIndex > 0 &&
            ...
            ((v = "(?: " + v + ")"), (m = " " + m), b++),
          (n = new RegExp("^(?:" + v + ")", g))),
        En && (n = new RegExp("^" + v + "$(?!\\s)", g)),
        Cn && (i = s.lastIndex),
        (o = d(yn, p ? n : s, m)),
        p
          ? o
            ? ((o.input = jn(o.input, b)),
              (o[0] = jn(o[0], b)),
              (o.index = s.lastIndex),
              (s.lastIndex += o[0].length))
            : (s.lastIndex = 0)
          : Cn && o && (s.lastIndex = s.global ? o.index + o[0].length : i),
        En &&
          o &&
          o.length > 1 &&
          d(mn, o[0], n, function () {
        ...
        for (o.groups = a = fn(null), r = 0; r < f.length; r++)
          a[(l = f[r])[0]] = o[l[1]];
      return o;
    });
  var An = wn;
  He({ target: "RegExp", proto: !0, forced: /./.exec !== An }, { exec: An });
  var In = bt("species"),
    Tn = RegExp.prototype,
    Nn = function (t, e, n, i) {
      var o = bt(t),
      ...
      if (!r || !a || n) {
        var l = S(/./[o]),
          s = e(o, ""[t], function (t, e, n, i, o) {
            var a = S(t),
              s = e.exec;
            return s === An || s === Tn.exec
              ? r && !o
                ? { done: !0, value: l(e, n, i) }
                : { done: !0, value: a(n, e, i) }
              : { done: !1 };
          });
        ce(String.prototype, t, s[0]), ce(Tn, o, s[1]);
      }
      i && Ht(Tn[o], "sham", !0);
    },
    On = S("".charAt),
    ...
    qn = { codeAt: Rn(!1), charAt: Rn(!0) }.charAt,
    Bn = function (t, e, n) {
      return e + (n ? qn(t, e).length : 1);
    },
    Mn = c.TypeError,
    Hn = function (t, e) {
      var n = t.exec;
      if (P(n)) {
        var i = d(n, t, e);
        return null !== i && Nt(i), i;
      }
      if ("RegExp" === k(t)) return d(An, t, e);
      throw Mn("RegExp#exec called on incompatible receiver");
    };
  Nn("match", function (t, e, n) {
    return [
      function (e) {
        var n = N(this),
          i = null == e ? void 0 : Q(e, t);
        return i ? d(i, e, n) : new RegExp(e)[t](Ke(n));
      },
      function (t) {
        var i = Nt(this),
          o = Ke(t),
        ...
        if (!i.global) return Hn(i, o);
        var a = i.unicode;
        i.lastIndex = 0;
        for (var l, s = [], c = 0; null !== (l = Hn(i, o)); ) {
          var u = Ke(l[0]);
          (s[c] = u),
            "" === u && (i.lastIndex = Bn(o, be(i.lastIndex), a)),
            c++;
        }
        return 0 === c ? null : s;
      },
  ...
  He(
    { target: "Array", proto: !0, forced: !ai || !li },
    {
      concat: function (t) {
        var e,
          n,
        ...
        for (e = -1, i = arguments.length; e < i; e++)
          if (si((r = -1 === e ? a : arguments[e]))) {
            if (s + (o = me(r)) > ii) throw ri(oi);
            for (n = 0; n < o; n++, s++) n in r && $n(l, s, r[n]);
          } else {
            if (s >= ii) throw ri(oi);
            $n(l, s++, r);
          }
  ...
  De || ce(Object.prototype, "toString", ci, { unsafe: !0 });
  var ui = se.PROPER,
    hi = "toString",
    fi = RegExp.prototype,
    pi = fi.toString,
    ...
    ce(
      ...
      function () {
        ...
        return (
          ...
          e +
          "/" +
          Ke(void 0 === n && B(fi, t) && !("flags" in fi) ? di(t) : n)
        );
      },
      { unsafe: !0 }
    );
  var bi = Function.prototype,
    ...
    wi =
      ...
      (f
        ? yi.bind(mi)
        : function () {
            return yi.apply(mi, arguments);
          }),
    _i = bt("match"),
    xi = function (t) {
      var e;
      return L(t) && (void 0 !== (e = t[_i]) ? !!e : "RegExp" == k(t));
    },
    Si = c.TypeError,
    ji = bt("species"),
    Ci = function (t, e) {
      var n,
        i = Nt(t).constructor;
      return void 0 === i || null == (n = Nt(i)[ji])
        ? e
        : (function (t) {
            if (Xn(t)) return t;
            throw Si(Y(t) + " is not a constructor");
          })(n);
    },
    ki = c.Array,
    Ei = Math.max,
            ...
            ? function (t, n) {
                ...
                for (
                  ...
                  !(
                    (a = h.lastIndex) > u &&
                    (Li(s, Ri(i, u, r.index)),
                    r.length > 1 && r.index < i.length && wi(Oi, s, Ai(r, 1)),
                    (l = r[0].length),
                    (u = a),
                    s.length >= o)
                  );
                ...
                return (
                  u === i.length
                    ? (!l && Pi(h, "")) || Li(s, "")
                    : Li(s, Ri(i, u)),
                  s.length > o ? Ai(s, 0, o) : s
                );
              }
            : "0".split(void 0, 0).length
            ? function (t, n) {
                return void 0 === t && 0 === n ? [] : d(e, this, t, n);
              }
            : e),
        [
          function (e, n) {
            var o = N(this),
              r = null == e ? void 0 : Q(e, t);
            return r ? d(r, e, o, n) : d(i, Ke(o), e, n);
          },
          function (t, o) {
            var r = Nt(this),
              a = Ke(t),
            ...
            var s = Ci(r, RegExp),
              ...
              u =
                ...
                (r.unicode ? "u" : "") +
                (Ii ? "g" : "y"),
              h = new s(Ii ? "^(?:" + r.source + ")" : r, u),
              f = void 0 === o ? Ti : o >>> 0;
            if (0 === f) return [];
            if (0 === a.length) return null === Hn(h, a) ? [a] : [];
            for (var p = 0, d = 0, g = []; d < a.length; ) {
              ...
              if (
                null === b ||
                (v = Ni(be(h.lastIndex + (Ii ? d : 0)), a.length)) === p
              )
                d = Bn(a, d, c);
              else {
                if ((Li(g, Ri(a, p, d)), g.length === f)) return g;
                for (var m = 1; m <= b.length - 1; m++)
                  if ((Li(g, b[m]), g.length === f)) return g;
                d = p = v;
              }
            }
            return Li(g, Ri(a, p)), g;
          },
        ]
      );
    },
    ...
    Vi =
      ...
      u(function () {
        ...
        return (
          ...
          7 != zi({}, t)[n] || tn(zi({}, e)).join("") != i
        );
      })
        ? function (t, e) {
            for (
              var n = at(t), i = arguments.length, o = 1, r = Ee.f, a = b.f;
              i > o;
              ...
              for (
                var l,
                  s = I(arguments[o++]),
                  c = r ? Wi(tn(s), r(s)) : tn(s),
                  u = c.length,
                  f = 0;
                u > f;

              )
                (l = c[f++]), (h && !d(a, s, l)) || (n[l] = s[l]);
            return n;
          }
        : zi;
  function Ui(t) {
    var e = t.parentNode;
    return (
      !(!e || "HTML" === e.nodeName) && ("fixed" === Mi(t, "position") || Ui(e))
    );
  }
  function Ki(t, e) {
    var n = document.body,
  ...
  He(
    { target: "Object", stat: !0, forced: Object.assign !== Vi },
    { assign: Vi }
  );
  var Yi = Math.floor,
    Xi = S("".charAt),
    ...
    Zi = /\$([$&'`]|\d{1,2}|<[^>]*>)/g,
    to = /\$([$&'`]|\d{1,2})/g,
    eo = function (t, e, n, i, o, r) {
      var a = n + t.length,
        l = i.length,
        s = to;
      return (
        void 0 !== o && ((o = at(o)), (s = Zi)),
        Ji(r, s, function (r, s) {
          var c;
          switch (Xi(s, 0)) {
            case "$":
  ...
  function po(t) {
    if (t) {
      ...
      var e = this._introItems[this._currentStep],
        n = Ki(e.element, this._targetElement),
        i = this._options.helperElementPadding;
      Ui(e.element)
        ? Bi(t, "introjs-fixedTooltip")
        : ho(t, "introjs-fixedTooltip"),
  ...
  Nn(
    ...
    function (t, e, n) {
      ...
      return [
        function (t, n) {
          var i = N(this),
            o = null == t ? void 0 : Q(t, no);
          return o ? d(o, t, i, n) : d(e, Ke(i), t, n);
        },
        function (t, o) {
          var r = Nt(this),
            a = Ke(t);
          if ("string" == typeof o && -1 === lo(o, i) && -1 === lo(o, "$<")) {
            var l = n(e, r, a, o);
            if (l.done) return l.value;
          }
          var s = P(o);
          ...
          for (var h = []; ; ) {
            ...
            if (null === f) break;
            if ((ao(h, f), !c)) break;
            "" === Ke(f[0]) && (r.lastIndex = Bn(a, be(r.lastIndex), u));
          }
          for (var p, d = "", g = 0, v = 0; v < h.length; v++) {
            for (
              var b = Ke((f = h[v])[0]),
                m = io(oo(fe(f.index), a.length), 0),
                y = [],
                w = 1;
              w < f.length;
              w++
            )
              ao(y, void 0 === (p = f[w]) ? p : String(p));
            var _ = f.groups;
            if (s) {
              var x = ro([b], y, m, a);
              void 0 !== _ && ao(x, _);
              var S = Ke(wi(o, void 0, x));
            } else S = eo(b, a, m, y, _, o);
            m >= g && ((d += so(a, g, m) + S), (g = m + b.length));
          }
          return d + so(a, g);
        },
      ];
  ...
  var go = bt("unscopables"),
    vo = Array.prototype;
  null == vo[go] && Mt.f(vo, go, { configurable: !0, value: fn(null) });
  var bo,
    mo = we.includes;
  He(
  ...
  var yo = S([].slice),
    ...
    So = Math.max;
  He(
    { target: "Array", proto: !0, forced: !wo },
    {
      slice: function (t, e) {
        var n,
          i,
        ...
        if (
          ...
          return yo(r, l, s);
        for (
          i = new (void 0 === n ? xo : n)(So(s - l, 0)), o = 0;
          l < s;
          l++, o++
        )
          l in r && $n(i, o, r[l]);
  ...
  var jo = c.TypeError,
    Co = function (t) {
      if (xi(t)) throw jo("The method doesn't accept regular expressions");
      return t;
    },
    ko = bt("match"),
    Eo = S("".indexOf);
      ...
      return function (s, c, u, h) {
        for (
          var p,
            ...
            y = 0,
            w = h || Zn,
            _ = e ? w(s, m) : n || a ? w(s, 0) : void 0;
          m > y;
          y++
        )
          if ((l || y in v) && ((d = b((p = v[y]), y, g)), t))
            if (e) _[y] = d;
            else if (d)
              switch (t) {
                case 3:
  ...
  He(
    { target: "Array", proto: !0, forced: !ei("filter") },
    {
      filter: function (t) {
  ...
  var Mo = ei("splice"),
    ...
    $o = Math.min,
    Do = 9007199254740991,
    zo = "Maximum allowed length exceeded";
  function Go(t, e) {
  ...
  function Wo(t, e, n) {
    var i = this._options.positionPrecedence.slice(),
      ...
      s = "floating";
    l.bottom + r > o.height && Go(i, "bottom"),
      l.top - r < 0 && Go(i, "top"),
      l.right + a > o.width && Go(i, "right"),
      l.left - a < 0 && Go(i, "left");
    var c,
      u,
    ...
    return (
      ...
      ["top", "bottom"].includes(s) &&
        (s += (function (t, e, n, i) {
          ...
          return (
            a - t < e && Go(l, "-left-aligned"),
            (t < r || a - t < r) && Go(l, "-middle-aligned"),
            t < e && Go(l, "-right-aligned"),
    ...
    if (
      ...
      switch (
        ...
        "floating" !== (s = this._introItems[this._currentStep].position) &&
          ...
          (s = Wo.call(this, t, e, s)),
        (a = Ki(t)),
        (r = Ki(e)),
        (l = Fi()),
        Bi(e, "introjs-".concat(s)),
        s)
      ) {
        case "top-right-aligned":
          n.className = "introjs-arrow bottom-right";
          var u = 0;
          Bo(a, u, r, e), (e.style.bottom = "".concat(a.height + 20, "px"));
          break;
        case "top-middle-aligned":
          n.className = "introjs-arrow bottom-middle";
          var h = a.width / 2 - r.width / 2;
          i && (h += 5),
            Bo(a, h, r, e) && ((e.style.right = null), qo(a, h, r, l, e)),
  ...
  function Ko(t, e) {
    ...
    for (var o in e) {
      var r = e[o];
      "style" === o ? fo(n, r) : o.match(i) ? n.setAttribute(o, r) : (n[o] = r);
    }
    return n;
  }
  function Yo(t, e, n) {
  ...
  function Jo() {
    ...
    null === t &&
      ((t = Ko("div", { className: "introjs-disableInteraction" })),
      this._targetElement.appendChild(t)),
      po.call(this, t);
  }
  function Qo(t) {
    var e = this,
      i = Ko("div", { className: "introjs-bullets" });
    ...
    return (
      n(this._introItems, function (e, n) {
        ...
        a.setAttribute("role", "presentation"),
          ...
          Di(l),
          (l.innerHTML = "&nbsp;"),
          l.setAttribute("data-step-number", i),
          a.appendChild(l),
          o.appendChild(a);
      }),
      i.appendChild(o),
  ...
  function Zo(t, e) {
    if (this._options.showBullets) {
      ...
      n && n.parentNode.replaceChild(Qo.call(this, e), n);
    }
  }
  function tr(t, e) {
  ...
  function er() {
    ...
    var e = Ko("div", { className: "introjs-progressbar" });
    return (
      ...
      e.setAttribute("aria-valuenow", Xo.call(this)),
      (e.style.cssText = "width:".concat(Xo.call(this), "%;")),
      t.appendChild(e),
      t
    );
  }
  function nr(t) {
    (t.querySelector(".introjs-progress .introjs-progressbar").style.cssText =
      "width:".concat(Xo.call(this), "%;")),
      t
        .querySelector(".introjs-progress .introjs-progressbar")
        .setAttribute("aria-valuenow", Xo.call(this));
  }
  function ir(t) {
    var e = this;
    ...
    if (
        ...
        (r._lastShowElementTimer = window.setTimeout(function () {
          null !== c &&
            ...
            ((null != n && /introjs-donebutton/gi.test(n.className)) ||
              null != n) &&
              n.focus(),
            $i.call(r, t.scrollTo, t, u);
        }, 350));
    } else {
      var d = Ko("div", { className: s }),
        g = Ko("div", { className: "introjs-tooltipReferenceLayer" }),
        v = Ko("div", { className: "introjs-arrow" }),
        b = Ko("div", { className: "introjs-tooltip" }),
        m = Ko("div", { className: "introjs-tooltiptext" }),
        y = Ko("div", { className: "introjs-tooltip-header" }),
        w = Ko("h1", { className: "introjs-tooltip-title" }),
        _ = Ko("div");
      fo(d, {
        "box-shadow":
        ...
        po.call(r, d),
        po.call(r, g),
        Yo(this._targetElement, d, !0),
        Yo(this._targetElement, g),
        (m.innerHTML = t.intro),
        (w.innerHTML = t.title),
        ...
        b.appendChild(y),
        b.appendChild(m),
        b.appendChild(Qo.call(this, t)),
        b.appendChild(er.call(this));
      var x = Ko("div");
      !0 === this._options.showStepNumbers &&
        ...
        ((n = Ko("a")).onclick = function () {
          r._introItems.length - 1 !== r._currentStep
            ...
            : /introjs-donebutton/gi.test(n.className) &&
              ...
              Wr.call(r, r._targetElement));
        }),
        Di(n),
        (n.innerHTML = this._options.nextLabel),
        ((i = Ko("a")).onclick = function () {
          0 !== r._currentStep && lr.call(r);
        }),
        Di(i),
        (i.innerHTML = this._options.prevLabel),
        Di((o = Ko("a", { className: "introjs-skipbutton" }))),
        ...
        _.appendChild(n),
        b.appendChild(_),
        Vo.call(r, t.element, b, v),
        $i.call(this, t.scrollTo, t, b);
    }
    var S = r._targetElement.querySelector(".introjs-disableInteraction");
    S && S.parentNode.removeChild(S),
      t.disableInteraction && Jo.call(r),
        ...
        ? (null != n &&
          ...
          !0 === this._options.hidePrev
            ? (null != i &&
              ...
              null != n && Bi(n, "introjs-fullbutton"))
            : null != i &&
              (i.className = "".concat(
                this._options.buttonClass,
        ...
        ? (null != i &&
          ...
          !0 === this._options.hideNext
            ? (null != n &&
              ...
              null != i && Bi(i, "introjs-fullbutton"))
            : null != n &&
      ...
      (function (t) {
        var e = t.element;
        Bi(e, "introjs-showElement");
        var n = Mi(e, "position");
        "absolute" !== n &&
          "relative" !== n &&
          "sticky" !== n &&
          "fixed" !== n &&
          Bi(e, "introjs-relativePosition");
      })(t),
      void 0 !== this._introAfterChangeCallback &&
        this._introAfterChangeCallback.call(this, t.element);
  }
  function or(t) {
    (this._currentStep = t - 2), void 0 !== this._introItems && ar.call(this);
  }
  function rr(t) {
    (this._currentStepNumber = t), void 0 !== this._introItems && ar.call(this);
  }
  function ar() {
    var t = this;
    ...
    return (
      ...
      !1 === i
        ...
        ? ("function" == typeof this._introCompleteCallback &&
          ...
          void Wr.call(this, this._targetElement))
        : void ir.call(this, e)
    );
  }
  function lr() {
  ...
  function cr(t) {
    ...
    if (
      ...
      if ("ArrowLeft" === e || 37 === e) lr.call(this);
      else if ("ArrowRight" === e || 39 === e) ar.call(this);
        ...
        n && n.className.match("introjs-prevbutton")
          ...
          ? (this._introItems.length - 1 === this._currentStep &&
            ...
            Wr.call(this, this._targetElement))
          : n && n.getAttribute("data-step-number")
          ? n.click()
          : ar.call(this),
          t.preventDefault ? t.preventDefault() : (t.returnValue = !1);
      }
    } else Wr.call(this, this._targetElement);
  }
  function ur(e) {
  ...
  function fr(t) {
    var e = hr('.introjs-hint[data-step="'.concat(t, '"]'))[0];
    _r.call(this),
      e && Bi(e, "introjs-hidehint"),
      void 0 !== this._hintCloseCallback &&
        this._hintCloseCallback.call(this, t);
  }
  function pr() {
    var t = this;
    n(hr(".introjs-hint"), function (e) {
      fr.call(t, e.getAttribute("data-step"));
    });
  }
  function dr() {
    var t = this,
    ...
    e && e.length
      ? n(e, function (e) {
          gr.call(t, e.getAttribute("data-step"));
        })
      : xr.call(this, this._targetElement);
  }
  function gr(t) {
    var e = hr('.introjs-hint[data-step="'.concat(t, '"]'))[0];
    e && ho(e, /introjs-hidehint/g);
  }
  function vr() {
    var t = this;
    n(hr(".introjs-hint"), function (e) {
      br.call(t, e.getAttribute("data-step"));
    }),
      i.off(document, "click", _r, this, !1),
      i.off(window, "resize", Sr, this, !0),
    ...
    n(this._introItems, function (n, i) {
      if (
        ...
        Di(r),
          ...
          n.hintAnimation || Bi(r, "introjs-hint-no-anim"),
          Ui(n.element) && Bi(r, "introjs-fixedhint");
        var a = Ko("div", { className: "introjs-hint-dot" }),
          l = Ko("div", { className: "introjs-hint-pulse" });
        r.appendChild(a),
          r.appendChild(l),
          r.setAttribute("data-step", i),
          (n.targetElement = n.element),
          (n.element = r),
          yr.call(t, n.hintPosition, r, n.targetElement),
          o.appendChild(r);
      }
    }),
  ...
  function wr(t) {
    ...
    var i = _r.call(this);
    if (parseInt(i, 10) !== t) {
      var o = Ko("div", { className: "introjs-tooltip" }),
        r = Ko("div"),
        a = Ko("div"),
        l = Ko("div");
  ...
  function xr(t) {
    ...
    mr.call(this),
      i.on(document, "click", _r, this, !1),
      i.on(window, "resize", Sr, this, !0);
  }
  function Sr() {
    var t = this;
      ...
      splice: function (t, e) {
        ...
        if (
          (0 === h
            ...
            : 1 === h
            ? ((n = 0), (i = c - u))
            : ((n = h - 2), (i = $o(Fo(fe(e), 0), c - u))),
          c + n - i > Do)
        )
          throw Ho(zo);
        for (o = Zn(s, i), r = 0; r < i; r++)
          (a = u + r) in s && $n(o, r, s[a]);
        if (((o.length = i), n < i)) {
          for (r = u; r < c - i; r++)
  ...
  var jr = Math.floor,
    Cr = function (t, e) {
      var n = t.length,
        i = jr(n / 2);
      return n < 8 ? kr(t, e) : Er(t, Cr(Ai(t, 0, i), e), Cr(Ai(t, i), e), e);
    },
    kr = function (t, e) {
    ...
    Ar = Cr,
    Ir = M.match(/firefox\/(\d+)/i),
    Tr = !!Ir && +Ir[1],
    Nr = /MSIE|Trident/.test(M),
    Or = M.match(/AppleWebKit\/(\d+)\./),
    Pr = !!Or && +Or[1],
    Lr = [],
    Rr = S(Lr.sort),
    qr = S(Lr.push),
    ...
    Fr = !u(function () {
      ...
      if (!(Tr && Tr > 3)) {
        ...
        for (t = 65; t < 76; t++) {
          ...
          for (i = 0; i < 47; i++) Lr.push({ k: e + i, v: n });
        }
        for (
          ...
          (e = Lr[i].k.charAt(0)), o.charAt(o.length - 1) !== e && (o += e);
    ...
    if (this._options.steps)
      n(this._options.steps, function (t) {
        ...
        if (
          ...
          null === i &&
            ((i = Ko("div", { className: "introjsFloatingElement" })),
  ...
  function Dr(t) {
    ...
    if (
      ...
      po.call(this, i),
      t &&
        ((this._introItems = $r.call(this, this._targetElement)),
        Zo.call(this, e, this._introItems[this._currentStep]),
        nr.call(this, e)),
      ...
      r &&
        o &&
        Vo.call(this, this._introItems[this._currentStep].element, r, o);
    }
    return Sr.call(this), this;
  }
  function zr() {
    Dr.call(this);
  }
  ...
  function Wr(t, e) {
    ...
    if (
      ...
      r &&
        ...
        Gr(t.querySelector(".introjs-helperLayer"), !0),
        Gr(t.querySelector(".introjs-tooltipReferenceLayer")),
        Gr(t.querySelector(".introjs-disableInteraction")),
        Gr(document.querySelector(".introjsFloatingElement")),
        Uo(),
        i.off(window, "keydown", cr, this, !0),
        i.off(window, "resize", zr, this, !0),
  ...
  function Vr(t) {
    var e = this,
      n = Ko("div", { className: "introjs-overlay" });
    return (
      fo(n, { top: 0, bottom: 0, left: 0, right: 0, position: "fixed" }),
      t.appendChild(n),
      ...
      0 === e.length ||
        ...
        Vr.call(this, t) &&
          ...
          this._options.keyboardNavigation &&
            i.on(window, "keydown", cr, this, !0),
          i.on(window, "resize", zr, this, !0))),
      !1
    );
  }
  He(
    { target: "Array", proto: !0, forced: Br || !Mr || !Hr || !Fr },
    {
      sort: function (t) {
        void 0 !== t && J(t);
        var e = at(this);
        if (Fr) return void 0 === t ? Rr(e) : Rr(e, t);
        var n,
          i,
          o = [],
          r = me(e);
        for (i = 0; i < r; i++) i in e && qr(o, e[i]);
        for (
          Ar(
            o,
            (function (t) {
    ...
    (Yr.fn = Kr.prototype =
      {
        ...
        previousStep: function () {
          return lr.call(this), this;
        },
        currentStep: function () {
          return sr.call(this);
        },
        exit: function (t) {
          return Wr.call(this, this._targetElement, t), this;
        },
        refresh: function (t) {
          return Dr.call(this, t), this;
        },
        ...
        addHints: function () {
          return xr.call(this, this._targetElement), this;
        },
        hideHint: function (t) {
          return fr.call(this, t), this;
        },
        hideHints: function () {
          return pr.call(this), this;
        },
        showHint: function (t) {
          return gr.call(this, t), this;
        },
        showHints: function () {
          return dr.call(this), this;
        },
        removeHints: function () {
          return vr.call(this), this;
        },
        removeHint: function (t) {
          return br().call(this, t), this;
        },
        showHintDialog: function (t) {
          return wr.call(this, t), this;
        },
      }),
    Yr
  );
